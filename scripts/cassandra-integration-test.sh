...
python socorro/collector/collector_app.py --admin.conf=./config/collector.with.cassandra.ini > collector.log 2>&1 &
python socorro/processor/processor_app.py --admin.conf=./config/processor.with.cassandra.ini > processor.log 2>&1 &
sleep 1
python socorro/middleware/middleware_app.py --admin.conf=./config/middleware.ini > middleware.log 2>&1 &
echo " Done."
